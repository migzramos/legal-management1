...
<body>
    <div class="container">
        <div class="card">
            <div class="header">
                <h1>LegalCase — New Message</h1>
            </div>
            <div class="body">
                <h2>New message from {{ $message->sender->name }}</h2>
                <p>{{ \Illuminate\Support\Str::limit($message->body, 100) }}</p>
                <div class="details">
                    <p><strong>Sender</strong><br>{{ $message->sender->name }}</p>
                    <p><strong>Preview</strong><br>{{ \Illuminate\Support\Str::limit($message->body, 100) }}</p>
                </div>
                <p>Continue the conversation in your LegalCase message center.</p>
                <a href="{{ $link }}" class="button">View Messages</a>
            </div>
            <div class="footer">
