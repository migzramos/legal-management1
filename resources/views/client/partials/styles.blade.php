...
.app-layout {
    ...
    min-height: 100vh;
    background:
        radial-gradient(ellipse 70% 55% at 8% 15%, rgba(124,58,237,0.10) 0%, transparent 65%),
        radial-gradient(ellipse 50% 45% at 92% 82%, rgba(168,85,247,0.07) 0%, transparent 65%),
        #0a0814;
}
...
.profile-avatar-card { background: var(--bg-card); border: 1px solid var(--border); border-radius: 16px; padding: 28px 20px; display: flex; flex-direction: column; align-items: center; gap: 16px; text-align: center; }
.profile-avatar-circle { width: 72px; height: 72px; border-radius: 16px; background: linear-gradient(135deg, var(--purple-core), var(--purple-light)); display: flex; align-items: center; justify-content: center; font-size: 1.8rem; font-weight: 700; color: #fff; }
.profile-name { font-family: 'Cormorant Garamond', serif; font-size: 1.2rem; font-weight: 600; color: var(--text-primary); }
.profile-email { font-size: 0.78rem; color: var(--text-muted); }
.profile-badge { display: inline-flex; align-items: center; padding: 4px 12px; border-radius: 20px; font-size: 0.68rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.06em; background: rgba(124,58,237,0.15); color: var(--purple-light); border: 1px solid rgba(124,58,237,0.25); }
.profile-meta { width: 100%; display: flex; flex-direction: column; gap: 10px; }
.profile-meta-item { display: flex; justify-content: space-between; align-items: center; padding: 10px 14px; background: rgba(255,255,255,0.03); border: 1px solid var(--border); border-radius: 10px; }
.profile-meta-label { font-size: 0.72rem; text-transform: uppercase; letter-spacing: 0.06em; color: var(--text-muted); }
.profile-meta-value { font-size: 0.84rem; color: var(--text-primary); font-weight: 500; }
...
.pagination .active span, .pagination span[aria-current="page"] span { background: var(--purple-core); border-color: var(--purple-core); color: #fff; }
...
@media (max-width: 640px) {
    ...
    .modal-payment-methods { grid-template-columns: 1fr; }
}
</style>
